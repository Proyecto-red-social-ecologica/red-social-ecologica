...
CREATE TABLE `puntos` (
  ...
  `puntos_dar` int(11) DEFAULT NULL,
  `id_reto` int(11) DEFAULT NULL,
  `id_usuario` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_puntos`),
  KEY `id_reto` (`id_reto`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `puntos_ibfk_1` FOREIGN KEY (`id_reto`) REFERENCES `retos` (`id_reto`),
  CONSTRAINT `puntos_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
