...
CREATE TABLE `retos` (
  ...
  `tipo_reto` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `puntos_dados` int(11) DEFAULT NULL,
  `reto_cumplido` tinyint(1) DEFAULT NULL,
  `id_admin` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_reto`),
  KEY `id_admin` (`id_admin`),
  CONSTRAINT `retos_ibfk_1` FOREIGN KEY (`id_admin`) REFERENCES `administrador` (`id_admin`)
